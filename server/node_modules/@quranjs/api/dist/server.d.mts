    ...
    content: {
        v4: {
            ...
            chapters: {
                ...
                getInfo: (id: ChapterId, query?: ApiParams) => Promise<ChapterInfo | null>;
                getInfoResponse: (id: ChapterId, query?: ApiParams) => Promise<ChapterInfoResponse>;
                list: (query?: ApiParams) => Promise<Chapter[]>;
            };
            hadithReferences: {
                byAyah: (key: VerseKey, query?: ApiParams) => Promise<HadithReferencesByAyahResponse>;
                countWithinRange: (from: VerseKey, to: VerseKey, query?: ApiParams) => Promise<HadithCountWithinRangeResponse>;
                hadithsByAyah: (key: VerseKey, query?: ApiParams) => Promise<HadithsByAyahResponse>;
            };
            juzs: {
                list: () => Promise<Juz[]>;
            };
